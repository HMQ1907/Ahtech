    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    <label for="customer_name" class="block text-sm font-medium text-gray-700 mb-1">Họ tên</label>
                ...
                <div>
                    <label for="customer_status" class="block text-sm font-medium text-gray-700 mb-1">Trạng thái</label>
            ...
            <div class="mt-4 flex flex-wrap gap-3">
                ...
                <button id="delete-search-customer"
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <div class="flex flex-wrap gap-4 items-center">
                    ...
                    <form id="importCusForm" enctype="multipart/form-data" class="flex items-center gap-3">
                        @csrf
                        <div class="flex items-center">
                            <input accept=".xls,.xlsx" type="file" class="hidden" id="excelFile" name="excelFile">
                            <label for="excelFile"
